      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="font-playfair text-xl text-primary-light">Navigation</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-primary-muted hover:text-primary-light transition-colors">
                <Github size={24} />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-primary-muted hover:text-primary-light transition-colors">
                <Linkedin size={24} />
              </a>
              <a href="mailto:contact@example.com" className="text-primary-muted hover:text-primary-light transition-colors">
                <Mail size={24} />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-playfair text-xl text-primary-light">Quote</h3>
