      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-24 md:mt-0">
        ...
        >
          ...
          >
            ...
            <span className="text-accent-contrast font-bold">master</span>{" "}
          ...
          >
            <Link
              to="/about"
              className="group px-8 py-4 bg-accent hover:bg-accent-light transition-all duration-300 rounded-full font-montserrat text-primary-light text-sm tracking-wide shadow-lg hover:shadow-xl hover:scale-105 transform"
            >
              Learn More About Me
            </Link>
            <Link
              to="/contact"
              className="group px-8 py-4 border-2 border-secondary bg-transparent hover:bg-secondary text-secondary hover:text-primary-light transition-all duration-300 rounded-full font-montserrat text-sm tracking-wide hover:shadow-lg hover:scale-105 transform"
            >
              Get in Touch
            </Link>
          </motion.div>
